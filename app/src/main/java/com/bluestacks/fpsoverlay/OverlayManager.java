    ...
    private void showFacePreview() {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                p.setRotation(270); // Orientasi manual yang sering salah di beda HP
                cam.setParameters(p);
                cam.startPreview();
                Thread.sleep(500); // Jeda "ajaib" agar kamera siap
                ...
                cam.takePicture(null, null, (data, camera) -> {
                    ...
                    camera.release(); // Harus dilepas manual, sering lupa dan bikin crash
                });
            } catch (Exception e) {
